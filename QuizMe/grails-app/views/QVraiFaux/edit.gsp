...
<html>
	...
	<body>
		<a href="#edit-QVraiFaux" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-QVraiFaux" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${QVraiFauxInstance?.version}" />
				<fieldset class="form">
